--this is the script you are not suppoost to see
...
local config = {
  ...
  print('Key: ' .. button)
  local file = io.open("C:\\Users\\tomst\\Desktop\\AHK\\macrokeyboardv3\\macrokeyboard.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
--print("we are inside the text file")
  file:write(config[button])
