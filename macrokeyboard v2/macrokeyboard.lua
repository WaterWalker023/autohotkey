...
local config = {
  ...
  print('Key: ' .. button)
  local file = io.open("C:\\Users\\Tomst\\OneDrive - Mediacollege Amsterdam\\Bureaublad\\ahk\\macrokeyboard v2\\macrokeyboard.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
